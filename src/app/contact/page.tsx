      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your message has been received. One of our insurance specialists will contact you within 24 hours.
          </p>
          <button
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Get Your Free <span className="text-blue-300">Insurance Quote</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Ready to protect your family? Contact our insurance experts today for a personalized quote 
              and find the perfect coverage for your needs.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="agreeToTerms" className="ml-3 text-sm text-gray-600">
                    ...
                    . I consent to being contacted about insurance products and services. *
                  </label>
                </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Monday - Friday: 8AM - 8PM</p>
              ...
              <div className="bg-blue-50 rounded-lg p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose SecureLife?</h3>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-gray-700">Licensed insurance professionals</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-gray-700">Competitive rates from top insurers</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-gray-700">Ongoing support and service</span>
                  </li>
                </ul>
              </div>
            </div>
